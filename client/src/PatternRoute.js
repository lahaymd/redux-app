...
class PatternRoute extends Component {
  ...
  render() {
    return (
      <div>
        <input type="text" onChange={this.handleSize} id="width" />
        width
        <input type="text" onChange={this.handleSize} id="height" />
        height
        <input
          type="range"
          min=".01"
        ...
        <input type="text" onChange={this.handleViewBox} id="width" />
        width
        <input type="text" onChange={this.handleViewBox} id="height" />
        height
